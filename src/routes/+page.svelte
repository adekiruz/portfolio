	...
	<div class="space-y-10 text-center flex flex-col items-center">
		...
		<div class="pt-16 pb-8 mx-auto max-w-5xl px-4 sm:pt-24">
			<div class="text-center">
				<h1
					class="prose dark:prose-invert font-extrabold text-3xl sm:text-5xl md:text-6xl pb-3 md:pb-0"
				>
					Boilerplate for SvelteKit Projects
				</h1>
				<p
					class="prose dark:prose-invert mt-10 max-w-md mx-auto text-base sm:text-lg md:text-xl md:max-w-3xl"
				>
					<span class="">Explore the existing pages:</span>
				</p>
